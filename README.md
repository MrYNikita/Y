...
- Улучшения
  - web
    - html
      - element
        - Теперь регулярные выражения не привязаны к позициям в строке.
        - stringDecompose
          - Теперь переименован в decomposeString.
          - Теперь быстрее в два раза.
          - Теперь может принимать сложные строки с указанием большого количества элементов.
          - Теперь вложенные элементы не называются детьми. Их новое имя - вложения.
          - Теперь возвращает массив.
          - Теперь текст - параметр, а не отдельное обозначение.
- Добавления
- Исправления
  - web
    - html
      - element
        - stringDecompose
          - Исправлен поиск вложенных элементов.
***
## Комментарий
**YExtension**
