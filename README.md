...
- Удаления
    - YLog
        - Метод appendNotice помечен как устаревший и будет удален.
- Улучшения
    - Теперь процедуры можно создавать через массивы.
- Добавления
    - YCMD
        - Добавлен метод для выполнения команд в cmd.
        - Добавлено свойство pathBegin.
        - Добавлено свойство pathNow.
        - Добавлено свойство detached.
    - YLog
        - Добавлен метод write.
        - Добавлен метод report.
        - Добавлен метод getReport.
        - Добавлено свойство sectionDefault.
    - ject
        - setDeep
            - Добавлена возможность тотального глубокого изменения. Эта возможность позволяет заменить все совпадения в объекте на указанное значение.
        - Добавлена ФЦ replaceDeep как аналог setDeep, но для замены значений.
        - Добавлена ФЦ getPathDeep для получения карты объекта.
    - YFunc
        - Добавлено свойство card. Карта процедур позволяет создать визуальную последовательность и привязать к ней необходимые процедуры.
    - YString
        - Добавлен метод reflect.
        - Добавлен метод setCursorTo.
        - Добавлен метод setCursorSize.
- Исправления
    - ject
        - setDeep
            - Исправлена критическая ошибка бесконечного цикла.
