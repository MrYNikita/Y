...
- Улучшения
    - Конфигурация
        - Добавлены дополнительные экспорты для отдельных модулей.
        - Изменена структура шаблонов конфигурации для логирования.
    - Документация
        - Добавлены новые пункты содержания.
        - Добавлен раздел документации Планы.
        - Добавлен раздел документации Комментарий.
        - Составлен список планов на данный момент.
        - Убраны выделения.
- Добавления
    - Модули
        - Добавлен вложенный модуль notice.
        - Добавлен вложенный модуль notices.
        - Добавлен класс YLog.
        - Добавлен модуль web.
        - Добавлен вложенный модуль web.server.
        - Добавлен вложенный модуль web.server.api.
