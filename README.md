...
- Улучшения
  - YString
    - find
      - Теперь учитывается возможность нахождения множественных соответствий. Они разделяются запятой.
  - element
    - create
      - Теперь элементы учитывают указанные свойства и присуждают их элементу.
    - REProperty
      - Теперь может искать свойства с мерой rem.
- Добавления
- Исправления
  - YStyle
    - #before
      - Исправлено извлечение проекторов.
    - change
      - Исправлена ошибка определения селектора, где точка воспринималась как часть регулярного выражения поиска.
  - element
    - stringDecompose
      - Исправлена ошибка распознования вложенных элементов из-за вхождения разделителей указания вложенных элементов.
    - REProperty
      - Исправлена ошибка поиска свойств с указанием значения, где значение терялось.
***
## Комментарий
***
## Планы
