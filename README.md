...
- Добавления
    - Модули
        - string
            - 
        - Добавлен модуль regexp
            - Добавлена ФЦ разделения регулярного выражения regexpSplit.
            - Добавлен класс YRegExp
                - Добавлен класс YRegExpVariation. Класс вариаций в пределах одного регулярного выражения. В рамках класса YRegExp вариации описывают части регулярного выражения, разделенного символом `|`. Каждая вариация в свою очередь содержит свойство-перечень экземпляров `YRegExpSymbol` и `YRegExpBracket`.
                    - Добавлен класс YRegExpSymbol. Класс содержит свойства конкретного символа регулярного выражения. Среди описываемых свойств имеется указание самого символа, кол-во его повторений или квантификатор, также указывается состояние квантификатора.
                    - Добавлен класс YRegExpBracket. Класс со
...
## Комментарий
**Regexp**  
Данный модуль предназначен для создания регулярных выражений и управлением над ними. Модуль располагает ФЦ для преобразования регулярных выражений их разделения, дополнения.

Благодаря классу регулярных выражений открывается возможность создания 
