...
- Улучшения
  - web
    - html
      - style
        - Теперь для анимаций создан отдельный класс.
        - Теперь для анимаций определен дополнительный селектор ~.
      - element
        - create
          - Теперь создает исключительно один элемент, вместо множества.
          - Теперь размещение элементов вынесено в отдельную функцию, но сама возможность размещения осталась доступна функции.
          - Теперь для размещения элементов используются селекторы, вместо отдельных свойств.
          - Оптимизирован алгоритм создания элемента.
        - YElement
          - Теперь добавлена возможность оборачивать уже существующие элементы.
          - Теперь добавлена возможность поиска и оборачивания уже существующих элементов.
- Добавления
  - web
    - html
      - element
        - Добавлена ФЦ для размещения элементов.
        - Добавлена ФЦ для создания множества элементов.
        - YElement
          - Добавлен статический метод поиска элемента и оборачивания искомого элемента.
          - Добавлен статический метод поиска множества элементов и их оборачивания.
      - style
        - Добавлен класс YStyle.
      - Добавлен класс YHandle.
- Исправления
***
## Комментарий
**YExtension**
