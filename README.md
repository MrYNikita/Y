...
- Улучшения
  - ject
    - equal
      - Добавлена реализация сравнения.
    - getPropertyByPath
      - Теперь можно манипулировать с указанием пути, с помощью строчных инструкций, для получения свойства по относительным путям.
- Добавления
- Перемещения
  - ject
    - getDeep -> getProperty
    - getByPath -> getPropertyByPath
- Исправления
