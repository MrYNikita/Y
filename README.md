...
- Улучшения
    - string
        - repaint
            - Теперь логика получения нужного цвета возложена на ФЦ getColor.
            - Логика получения цвета улучшена за счет удаления избыточной проверки на наличие вхождения в строку цвета слова 'bright'.
            - Учитывается указание варианта reset для сброса цвета.
- Добавления
- Исправления
    - YLog
        - Теперь логи отображаются в соответствии с их фактическим порядком добавления в журнал.
