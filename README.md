...
- Исправления
  - string
    - YString
      - repaint
        - Исправлена ошибка опеределения цвета значения. Теперь она определяет цвета без внесения изменений в исходную строку.
        - Исправлена ошибка отображения строки. Теперь отображается только цвет.
***
## Комментарий
**YExtension**
