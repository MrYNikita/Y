...
- Добавления
- Исправления
    - Исправлена критическая ошибка отсутсвия файла конфигурации.
    - YString
        - extract
            - Исправлена ошибка фильтрации совпадения. Вместо всего фрагмента совпадения удаляется точно совпадение.
            - Исправлена ситуация поиска элемента null, возникающего в том случае, если строка не содержит совпадения.
    - html.element
        - Исправлено распознавание строки создания элементов.
