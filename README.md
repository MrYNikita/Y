...
- Улучшения
- Добавления
    - Добавлен класс html.style YStyle. 
        - Добавлен метод change для указания свойств стиля. В качестве аргумента метода change может быть указан объект-носитель аргументов типа CSSStyleDeclaration. Если свойство будет равно `''`, то стиль будет удален.
        - Добавлен метод delete для отката стиля.
    - Добавлен класс html.element YElementStyle.
        - Добавлена возможность отката стиля из элемента стилей с помощью метода remove.
- Исправления
    - string
        - find
            - Добавлена заявленная возможность поиска по строке с учетом синтаксиса регулярных выражений.
        - handle
            - Учтен вариант регулярного выражения для одного элемента.
    - element
        - Исправлено регулярное выражение для поиска и разбора строки создания элемента.
