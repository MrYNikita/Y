...
- Улучшения
  - YElement
    - Теперь переписан на SDIMFY-1.1
  - YEvent
    - Теперь события учитывают контекст. Это означает, что событие контекст привязанного к объекту события равен ему самому.
- Добавления
- Исправления
  - YInsert
    - get
      - Исправлена критическая ошибка при передаче метки шаблона без вставок.
***
## Комментарий
***
## Планы
