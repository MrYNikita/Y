...
=======
    - Часть классов были унаследованы от YBasic.
    - YServer
        - Осуществляется кеширование отправленных данных.
    - array
        - mix
            - Теперь перемешивание осуществялется за счет rearrange.
        - remove
            - Теперь доработана до конца.
            - Теперь удаляет все вхождения вместо первых совпадений.
            - Теперь корректно отображаются типы данных для аргументов.
            - Теперь звено удаления по элементам называется byElement.
            - Теперь можно удалять значения по индексам.
        - unique
            - Теперь работает с исходным массивом.
            - Теперь корректно указаны аргументы.
            - Теперь работает за счет remove функции.
- Добавления
    - Добавлен новый вид классов SDIFY-1.0.
    - YBasic
        - Добавлен базовый класс.
    - number
        - Добавлен класс YRange.
    - array
        - Добавлена ФЦ rearrange для перестановок элементов внутри массива.
        - remove
            - Добавлено звено ByIndex.
- Исправления
    - YServer
        - Исправлены заголовки. Теперь для них указывается кодировка utf-8.
        - Устранена уязвимость с X-Type-Content.
>>>>>>> main
