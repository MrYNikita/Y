...
- Улучшения
    - path
        - get
            - Оптимизирован код алгоритма - убран избыточный код.
- Добавления
    - path
        - get
            - Добавлен логический аргумент full для определения необходимости возврата полного пути до искомого файла.
            - Добавлена возможность получения полного пути до искомого файла.
    - YDirectory
        - Добавлены методы getReport и report.
    - YFile
        - Добавлены методы getReport и report.
    - Добавлен cache.json для хранения данных и оптимизации работы программы.
- Исправления
    - file
        - Функции исправлены с учетом новых модификаций для файлов.
    - YServer
        - Исправлена ошибка при указании параметров в url.
    - YFile
        - Исправлены ошибки поиска файла при указании фрагмента пути в качестве аргумента для конструктора.
    - YDirectory
        - Исправлены ошибки поиска файла при указании фрагмента пути в качестве аргумента для конструктора.
        - Исправлено указание всех путей папки, которое теперь отображено в полной мере.
